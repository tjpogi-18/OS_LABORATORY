...
//ALGORITHM
    ...
    //q1 : p1,p2,p3  |RR(4)    | 7,8,9
    //q2 : p4,p5,p6  |PS    ---| Round Robin (10) 4, 5 6
    //q3 : p7,p8,p9  |FCFS     | 1, 2 3
...
int main(){
    ...
    } //Allocate Memory for Each Queue// BERNARDO
    ...
    } //The code loops through all processes and checks which queue they belong to. FORMON
    ...
    for(int i=0;i<3;i++){
        ...
        cout<<"NULL\n";
    }// DISPLAY THE QUEUE DISPLAY KUNG ANO LAMAN NG QUEUE : FULGAR
